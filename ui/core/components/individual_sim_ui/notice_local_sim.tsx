		...
		this.toast = new Toast({
			...
			body: (
				<div>
					...
					<a href="https://github.com/isfir/wowsims-turtle/releases" className="btn btn-outline-light" target="_blank" onclick={() => this.setHasSeenNotice()}>
						Download
					</a>
				</div>
			),
